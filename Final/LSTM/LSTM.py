...
#http://thesai.org/Downloads/Volume8No10/Paper_46-Emotion_Recognition_based_on_EEG_using_LSTM.pdf
...
def build_model():
    model = Sequential()
    model.add(LSTM(64, activation='relu', recurrent_activation='hard_sigmoid', \
...
def build_inputs(files_list, accel_labels, file_label_dict, norm_bool, std_bool, center_bool):
    ...
    for path in files_list:
        ...
        normed_data = vectorize(normed_data)
